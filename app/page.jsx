...
import {
  ...
  SocialLink,
  FooterLink,
} from "./components/ComponentsContainer";
...
function BackToTopButton() {
  ...
  return (
    <button
      onClick={scrollToTop}
      className={`fixed bottom-[20px] right-[20px] w-[45px] h-[45px] bg-black flex_center rounded-full ${
    ...
    <main className="w-full h-auto relative flex flex-col items-center">
          ...
          <div className="flex_itemsStartColmn relative w-[50%] min-[1500px]:w-[45%] text-white pl-8 gap-6 max-lg:w-full max-lg:items-center max-lg:py-5 max-lg:pl-4 max-lg:px-4">
            ...
            <div className="flex_itemsStartColmn gap-6 w-[90%] relative">
              ...
              <div className="w-full h-[55px] flex_center overflow-hidden relative">
                <input
                  type="text"
                  className="w-full h-full bg-white px-6  rounded-[50px] text-black placeholder:text-black"
      ...
      <section className="h-auto   flex_col_center gap-10 ">
        ...
        <div className="title w-full relative flex_center flex-col gap-3 text-center px-4">
          <h2 className="font_title leading-[1] font-bold">
            How It works? Find a perfect home
          </h2>
          <p className="font_normal sub_title">
            Discover how JustHome helps you find the right property quickly, securely, and without hassle.
          </p>
        </div>
        ...
        <div className="w-full relative flex_center flex-wrap gap-10 xl:gap-28">
          <div className="flex_col_center gap-4 w-[287.79px] text-center">
            ...
            <p>
              Use smart filters to find homes that match your location, budget, and lifestyle needs.
            </p>
          </div>
          ...
          <div className="flex_col_center gap-4 w-[287.79px] text-center">
            ...
            <p>
              Get expert guidance, transparent information, and personalized property recommendations.
            </p>
          </div>
          ...
          <div className="flex_col_center gap-4 w-[287.79px] text-center">
            ...
            <p>
              Finalize your deal with confidence and secure your new home effortlessly.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="h-auto flex_col_center gap-10 ">
        {/* top section */}
        <div className="title relative flex items-end justify-between gap-3 text-center lg:text-left px-4 w-[95%] lg:w-[95%] max-w-[1700px]  max-lg:flex-col max-lg:items-center max-lg:gap-4">
          {/* title */}
      ...
      <section className="h-auto flex_col_center gap-10  ">
        ...
        <div className="title relative flex items-end justify-between gap-3 text-center lg:text-left px-4 w-[95%] lg:w-[95%] max-w-[1700px] max-lg:flex-col max-lg:items-center max-lg:gap-4">
          ...
          <div className="flex flex-col max-lg:gap-4">
            ...
            <p className="font_normal sub_title">Handpicked Properties with the Best Value</p>
          </div>
      ...
      <section className="w-full  relative h-auto flex_center">
        <div className="bg_secondary rounded-xl w-[90%] h-auto lg:h-[300px] max-w-[2000px] flex_between px-4 lg:px-6 min-[1700px]:px-20 flex-col lg:flex-row max-lg:py-4 max-lg:text-center gap-10">
          <div className="flex_itemsStartColmn lg:max-w-[50%]">
            <h4 className="font-bold font_title">Take a look at our numbers</h4>
            <p className="font_normal">
              Our growing community and successful transactions reflect our commitment to quality service, transparency, and customer satisfaction.
            </p>
          </div>
      ...
      <section className="w-full flex_center  flex-col gap-20">
        ...
        <div className="title relative flex items-end justify-between gap-3 text-center lg:text-left px-4 w-[95%] lg:w-[90%] max-w-[1700px] max-lg:flex-col max-lg:items-center max-lg:gap-4">
          ...
          <div className="flex flex-col max-lg:gap-4">
            ...
            <p className="font_normal sub_title">
              Top Locations with High Demand and Great Opportunities
            </p>
          </div>
        ...
        <div className="flex_center flex-wrap relative w-full gap-2 sm:gap-4 h-auto lg:h-[500px] min-[1600px]:h-[668px] max-w-[1900px] ">
          ...
          <div className="min-w-[200px] w-[47%] lg:w-[28%] h-[370px] lg:h-full rounded-2xl overflow-hidden flex_center relative">
            ...
            {/* about cities */}
            <AboutCities properties="8" cities="New York" />
          </div>
          ...
          <div className="min-w-[200px] w-[47%] lg:w-[28%] h-[370px] lg:h-full  overflow-hidden flex justify-between items-center flex-col relative max-[400px]:flex-row max-[400px]:w-full max-[400px]:justify-center max-[400px]:gap-4 max-[400px]:h-[200px]">
            ...
            <div className="relative w-full rounded-2xl h-[48%] overflow-hidden flex_center max-[400px]:w-[47%] max-[400px]:h-full">
              ...
              <AboutCities properties="2" cities="Chicago" />
            </div>
            ...
            <div className="relative w-full rounded-2xl h-[48%] overflow-hidden flex_center max-[400px]:w-[47%] max-[400px]:h-full">
              ...
              <AboutCities properties="0" cities="San Diego" />
            </div>
          </div>
          ...
          <div className="min-w-[200px] w-[98%] lg:w-[28%] h-[200px] lg:h-full  overflow-hidden flex justify-center lg:justify-between items-center flex-col max-lg:flex-row max-lg:gap-4 relative">
            ...
            <div className="relative w-[48%] lg:w-full rounded-2xl h-full lg:h-[48%] overflow-hidden flex_center">
              ...
              <AboutCities properties="1" cities="Los Angeles" />
            </div>
            ...
            <div className="relative w-[48%] lg:w-full rounded-2xl h-full lg:h-[48%] overflow-hidden flex_center">
              ...
              <AboutCities properties="3" cities="Florida" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full flex_center flex-col gap-6">
        <h3 className="text-center font_normal px-4">
      ...
      <section className="h-auto   flex_col_center gap-10 ">
        ...
        <div className="relative w-full flex_center gap-7 flex-wrap">
          ...
          <div className="flex_itemsStartColmn gap-4 w-1/3 sm:w-1/4 lg:w-1/6 max-w-[350px]">
            ...
            {/* name */}
            <div className="relative">
              <p className="font-bold font_normal md:font_large">
                Thomas Powell
              </p>
        ...
        <div className="w-full lg:w-1/2 flex_center relative ">
          <div className=" w-[90%] md:w-[80%] min-[1800px]:w-[70%] flex flex-col items-start gap-6 max-lg:items-center">
            <div className="title w-full relative   text-left ">
              <h2 className="font_title leading-[1.1] font-bold">
            ...
            <div className="w-full flex justify-between  ">
              <div className="w-[45%] ">
                ...
                <p className="leading-[1.2] md:leading-[1.7] font_small">
              ...
              <div className="w-[45%] ">
                <h2 className="font-bold font_large mb-4">
...
`}
          ...
          <FaqContainer
            ...
            answer={`After completing your purchase, you’ll receive a download link in your email confirmation. Alternatively, you can access your purchased themes anytime by logging into your account and navigating to the "Downloads" section. If you encounter any issues, our support team is available to assist you promptly.`}
          />
        </div>
      </section>
      ...
      <section className="flex_items lg:px-[10%] max-lg:flex-col gap-5">
        ...
        <div className="title w-full relative flex flex-col max-lg:items-center gap-3 text-center lg:text-left px-4">
          <h2 className="text-[30px] leading-[1] font-bold">
      ...
      <footer className="relative w-full bg-[#1f4b43] py-[10%] lg:py-[3%] px-[5%]  flex_col_center gap-10 max-w-[100%] overflow-x-hidden">
        ...
        <div className="w-full flex_between flex-wrap max-lg:justify-center max-lg:gap-5">
          ...
          <div className="flex_center gap-4 md:gap-5 max-lg:w-full">
            <p className="text-[15px] md:font_xl_large font-bold text-white">
              Follow Us
            </p>
        ...
        <div className="w-full flex justify-center lg:justify-between flex-wrap gap-4 lg:gap-0">
          ...
          <div className=" w-full md:w-[300px] min-[1500px]:w-[400px] flex_itemsStartColmn gap-5">
            <p className="w-full text-left font_xl_large opacity-60 text-white tracking-[.05rem]">
              Subscribe
            </p>
            ...
            <div className="inputForm h-[70px] w-full relative border-b-[#ffffff91] border-b-[1px] flex_center">
              <input
                ...
                name="email"
                id="email"
                className="emailForm absolute w-full h-full text-white bg-transparent font_small"
            ...
            <p className="font_small text-white text-center">
          ...
          <div className="w-[45%] lg:w-auto flex flex-col gap-3">
            {/* title */}
            <p className="text-[16px] min-[1600px]:text-[19px] text-[#ffffff78]">
              Discover
            </p>
          ...
          <div className="w-full lg:w-auto flex flex-col gap-3 max-lg:items-center">
            ...
            <a
              ...
              target="_blank"
              className="app duration-200 hover:opacity-90 flex_center relative rounded-lg bg-[#ffffff28] w-[50%] min-w-[170px] md:w-[180px] min-[1500px]:w-[210px] h-[58px] min-[1500px]:h-[63px]  gap-4"
            >
              ...
              <div className="aboutApp text-white">
                <p className="text-[10px] min-[1500px]:text-[13px] ">
                  Download on the
                </p>
                <b className="text-[14px] min-[1500px]:text-[16px]">
                  Apple Store
                </b>
              </div>
            </a>
